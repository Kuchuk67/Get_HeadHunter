...
### файл config.py
Дополнительные настройки программы и API запросов 

## Описание классов

* [class Vacancies()](#Vacancies)
* [class IterVacancies](#IterVacancies)
* [class Vacancy](Vacancy)
* [class CompareVacancies](CompareVacancies)
* [class GetAPI(ABC)](GetAPI)
...
vacancy_del(self, id_v) -> bool:
        """Удаляет  вакансию"""

created(self, x: list) -> list:
"""Отдает список объектов с вакансиями"""

sort_date(self) -> None:
        """ Сортирует список вакансий по дате """
sort_salary(self) -> None:
